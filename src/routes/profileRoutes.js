...
const { getProfile, updateProfile, getTotalEvents, changePassword, logout, updateAllNotifications, updateChatNotifications } = require("../controllers/profileController");
